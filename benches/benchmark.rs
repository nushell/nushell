...
fn bench_create_record(n: i32) -> impl IntoBenchmarks {
    bench_command(
        &format!("create_record_{n}"),
...
fn bench_create_table(n: i32) -> impl IntoBenchmarks {
    bench_command(
        &format!("create_table_{n}"),
...
tango_benchmarks!(
    ...
    // Data types
    // Record
    bench_create_record(1),
    bench_create_record(10),
    bench_create_record(100),
    bench_create_record(1_000),
    bench_flat_access(1),
    bench_flat_access(10),
    bench_flat_access(100),
    bench_flat_access(1_000),
    bench_nested_access(1),
    bench_nested_access(2),
    bench_nested_access(4),
    bench_nested_access(8),
    bench_nested_access(16),
    bench_nested_access(32),
    bench_nested_access(64),
    bench_nested_access(128),
    // Table
    bench_create_table(1),
    bench_create_table(10),
    bench_create_table(100),
    bench_create_table(1_000),
    bench_table_get(1),
    bench_table_get(10),
    bench_table_get(100),
