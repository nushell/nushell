...
fn plugin_add_then_restart_nu(playground: Playground) -> Result {
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_add_in_nu_plugin_dirs_consts(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_add_in_nu_plugin_dirs_env(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
...
fn plugin_rm_then_restart_nu(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
    let mut tester = test();
...
#[test]
#[deps(NU)]
fn plugin_rm_not_found(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let outcome: Record =
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn warning_on_invalid_plugin_item(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
...
#[test]
#[deps(NU)]
fn plugin_use_error_not_found(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_shows_up_in_default_plugin_list_after_add(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let commands = format!(
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_shows_removed_after_removing(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let mut tester = test();
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_add_and_then_use(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
    let mut tester = test();
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_add_and_then_use_by_filename(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
    let mut tester = test();
...
#[test]
#[deps(NU, NU_PLUGIN_EXAMPLE)]
fn plugin_add_then_use_with_custom_path(playground: Playground) -> Result {
    let configs = EmptyConfigs::new(playground.path());
    let nu = configs.nu();
    let mut tester = test();
