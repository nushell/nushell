...
// There are currently no custom values defined by the engine that aren't hidden
// behind an extra feature, both database and dataframes are hidden behind
// --features=extra so we need to guard this test
#[cfg(feature = "sqlite")]
#[test]
