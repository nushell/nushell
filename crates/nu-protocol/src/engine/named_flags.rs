...
//!
//! Used by IR evaluation before dispatch and by const evaluation when building
//! IR-shaped calls.
...
#[inline]
pub fn flag_type_accepts_nothing(flag: &Flag) -> bool {
    flag.type_accepts_nothing()
}

pub fn find_signature_flag<'a>(
...
pub fn data_from_name_and_short(name: &str, short: &str) -> (Arc<[u8]>, DataSlice, DataSlice) {
...
pub fn can_rest_spread(signature: &Signature) -> bool {
...
pub fn list_spread_before_required_error(spread_span: Span) -> ShellError {
...
pub fn normalize_engine_arguments(
    signature: &Signature,
    args: Vec<Argument>,
) -> Result<Vec<Argument>, ShellError> {
