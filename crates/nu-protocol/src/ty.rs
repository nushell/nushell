...
impl Type {
    ...
    pub fn to_shape(&self) -> SyntaxShape {
        ...
        match self {
            ...
            Type::FileMode => SyntaxShape::FileMode,
            Type::FilePermission => SyntaxShape::FilePermission,
    ...
    pub fn get_non_specified_string(&self) -> String {
        match self {
            ...
            Type::FileMode => String::from("filemode"),
            Type::FilePermission => String::from("filepermission"),
...
impl Display for Type {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Type::FileMode => write!(f, "filemode"),
            Type::FilePermission => write!(f, "filepermission"),
