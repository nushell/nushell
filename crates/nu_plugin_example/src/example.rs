...
impl Example {
    fn print_values(
        ...
        // Note. When debugging your plugin, you may want to print something to the
        // console Use the eprintln macro to print your messages. Trying to
        // print to stdout will cause a decoding error for your message
        eprintln!("Calling test {index} signature");
        eprintln!("value received {input:?}");

        // To extract the arguments from the Call object you can use the functions req,
        // has_flag, opt, rest, and get_flag
        //
        // Note that plugin calls only accept simple arguments, this means that you can
        // pass to the plug in Int and String. This should be improved when the plugin
        // has the ability to call back to NuShell to extract more information
