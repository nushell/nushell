...
fn serialize_argument(arg: &PositionalArg, mut builder: argument::Builder) {
    ...
    match arg.shape {
        ...
        SyntaxShape::Any => builder.set_shape(Shape::Any),
        SyntaxShape::CellPath => builder.set_shape(Shape::CellPath),
        SyntaxShape::FullCellPath => builder.set_shape(Shape::FullCellPath),
        SyntaxShape::Range => builder.set_shape(Shape::Range),
        SyntaxShape::Filepath => builder.set_shape(Shape::Filepath),
        SyntaxShape::GlobPattern => builder.set_shape(Shape::GlobPattern),
        SyntaxShape::ImportPattern => builder.set_shape(Shape::ImportPattern),
        SyntaxShape::Binary => builder.set_shape(Shape::Binary),
        SyntaxShape::Table => builder.set_shape(Shape::Table),
        SyntaxShape::Filesize => builder.set_shape(Shape::Filesize),
        SyntaxShape::Duration => builder.set_shape(Shape::Duration),
        SyntaxShape::DateTime => builder.set_shape(Shape::DateTime),
        SyntaxShape::Operator => builder.set_shape(Shape::Operator),
        SyntaxShape::RowCondition => builder.set_shape(Shape::RowCondition),
        SyntaxShape::MathExpression => builder.set_shape(Shape::MathExpression),
        SyntaxShape::Variable => builder.set_shape(Shape::Variable),
        SyntaxShape::VarWithOptType => builder.set_shape(Shape::VarWithOptType),
        SyntaxShape::Signature => builder.set_shape(Shape::Signature),
        SyntaxShape::Expression => builder.set_shape(Shape::Expression),
        SyntaxShape::Record => builder.set_shape(Shape::Record),
        // missing ones with parameters
        // SyntaxShape::Keyword(_, _) => todo!(),
        // SyntaxShape::Block(_) => todo!(),
        // SyntaxShape::List(_) => todo!(),
        // SyntaxShape::Custom(_, _) => todo!(),
...
fn serialize_flag(arg: &Flag, mut builder: flag::Builder) {
    ...
    match &arg.arg {
        ...
        Some(shape) => match shape {
            ...
            SyntaxShape::Any => builder.set_arg(Shape::Any),
            SyntaxShape::CellPath => builder.set_arg(Shape::CellPath),
            SyntaxShape::FullCellPath => builder.set_arg(Shape::FullCellPath),
            SyntaxShape::Range => builder.set_arg(Shape::Range),
            SyntaxShape::Filepath => builder.set_arg(Shape::Filepath),
            SyntaxShape::GlobPattern => builder.set_arg(Shape::GlobPattern),
            SyntaxShape::ImportPattern => builder.set_arg(Shape::ImportPattern),
            SyntaxShape::Binary => builder.set_arg(Shape::Binary),
            SyntaxShape::Table => builder.set_arg(Shape::Table),
            SyntaxShape::Filesize => builder.set_arg(Shape::Filesize),
            SyntaxShape::Duration => builder.set_arg(Shape::Duration),
            SyntaxShape::DateTime => builder.set_arg(Shape::DateTime),
            SyntaxShape::Operator => builder.set_arg(Shape::Operator),
            SyntaxShape::RowCondition => builder.set_arg(Shape::RowCondition),
            SyntaxShape::MathExpression => builder.set_arg(Shape::MathExpression),
            SyntaxShape::Variable => builder.set_arg(Shape::Variable),
            SyntaxShape::VarWithOptType => builder.set_arg(Shape::VarWithOptType),
            SyntaxShape::Signature => builder.set_arg(Shape::Signature),
            SyntaxShape::Expression => builder.set_arg(Shape::Expression),
            SyntaxShape::Record => builder.set_arg(Shape::Record),
            // missing ones with parameters
            // SyntaxShape::Block(_) => todo!(),
            // SyntaxShape::Keyword(_, _) => todo!(),
            // SyntaxShape::List(_) => todo!(),
...
fn deserialize_argument(reader: argument::Reader) -> Result<PositionalArg, ShellError> {
    ...
    let shape = match shape {
        ...
        Shape::CellPath => SyntaxShape::CellPath,
        Shape::FullCellPath => SyntaxShape::FullCellPath,
        Shape::Range => SyntaxShape::Range,
        Shape::Filepath => SyntaxShape::Filepath,
        Shape::GlobPattern => SyntaxShape::GlobPattern,
        Shape::ImportPattern => SyntaxShape::ImportPattern,
        Shape::Binary => SyntaxShape::Binary,
        Shape::Table => SyntaxShape::Table,
        Shape::Filesize => SyntaxShape::Filesize,
        Shape::Duration => SyntaxShape::Duration,
        Shape::DateTime => SyntaxShape::DateTime,
        Shape::Operator => SyntaxShape::Operator,
        Shape::RowCondition => SyntaxShape::RowCondition,
        Shape::MathExpression => SyntaxShape::MathExpression,
        Shape::Variable => SyntaxShape::Variable,
        Shape::Signature => SyntaxShape::Signature,
        Shape::Expression => SyntaxShape::Expression,
        Shape::Record => SyntaxShape::Record,
        Shape::VarWithOptType => SyntaxShape::VarWithOptType,
    };
...
fn deserialize_flag(reader: flag::Reader) -> Result<Flag, ShellError> {
    ...
    let arg = match arg {
        ...
        Shape::CellPath => Some(SyntaxShape::CellPath),
        Shape::FullCellPath => Some(SyntaxShape::FullCellPath),
        Shape::Range => Some(SyntaxShape::Range),
        Shape::Filepath => Some(SyntaxShape::Filepath),
        Shape::GlobPattern => Some(SyntaxShape::GlobPattern),
        Shape::ImportPattern => Some(SyntaxShape::ImportPattern),
        Shape::Binary => Some(SyntaxShape::Binary),
        Shape::Table => Some(SyntaxShape::Table),
        Shape::Filesize => Some(SyntaxShape::Filesize),
        Shape::Duration => Some(SyntaxShape::Duration),
        Shape::DateTime => Some(SyntaxShape::DateTime),
        Shape::Operator => Some(SyntaxShape::Operator),
        Shape::RowCondition => Some(SyntaxShape::RowCondition),
        Shape::MathExpression => Some(SyntaxShape::MathExpression),
        Shape::Variable => Some(SyntaxShape::Variable),
        Shape::Signature => Some(SyntaxShape::Signature),
        Shape::Expression => Some(SyntaxShape::Expression),
        Shape::Record => Some(SyntaxShape::Record),
        Shape::VarWithOptType => Some(SyntaxShape::VarWithOptType),
    };
