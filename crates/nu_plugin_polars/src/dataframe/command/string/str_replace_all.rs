    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            Example {
                ...
                example: "[[a]; [abac] [abac] [abac]] | polars into-df | polars select (polars \
                          col a | polars str-replace-all --pattern a --replace A) | polars collect",
                result: Some(
            ...
            Example {
                ...
                example: "[abac abac abac] | polars into-df | polars str-replace-all --pattern a \
                          --replace A",
                result: Some(
                    NuDataFrame::try_from_columns(
                        vec![Column::new(
