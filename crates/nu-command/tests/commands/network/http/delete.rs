...
fn http_delete_is_success() {
    ...
    let actual = nu!(r#"http delete {}"#, server.url());
...
fn http_delete_is_success_pipeline() {
    ...
    let actual = nu!(r#""foo" | http delete {}"#, server.url());
...
fn http_delete_follows_redirect() {
    ...
    let actual = nu!("http delete {}/foo", server.url());
...
fn http_delete_redirect_mode_manual() {
    ...
    let actual = nu!("http delete --redirect-mode manual {}/foo", server.url());
...
fn http_delete_redirect_mode_error() {
    ...
    let actual = nu!("http delete --redirect-mode error {}/foo", server.url());
...
fn http_delete_timeout() {
    ...
    let actual = nu!("http delete --max-time 100ms {}", server.url());
