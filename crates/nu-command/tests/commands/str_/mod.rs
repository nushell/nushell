...
#[test]
fn capitalizes(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [dependency]
...
#[test]
fn downcases(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [dependency]
...
#[test]
fn upcases(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [package]
...
fn camelcases(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [dependency]
...
#[test]
fn find_and_replaces(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [fortune.teller]
...
#[test]
fn find_and_replaces_without_passing_field(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [fortune.teller]
...
#[test]
fn regex_error_in_pattern(playground: Playground) -> Result {
    let code = r#"
        'source string'
...
#[test]
fn substrings_the_input(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [fortune.teller]
...
#[test]
fn substring_empty_if_start_index_is_greater_than_end_index(playground: Playground) -> Result {
    playground.file(
        "sample.toml",
        r#"
            [fortune.teller]
...
#[test]
fn substring_by_negative_index(playground: Playground) -> Result {
