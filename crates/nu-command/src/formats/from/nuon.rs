...
fn convert_to_value(
    ...
    match expr.expr {
        ...
        Expr::Filepath(val) => convert_to_value(*val, span, original_text),
        Expr::Directory(val) => convert_to_value(*val, span, original_text),
        ...
        Expr::GlobPattern(val) => convert_to_value(*val, span, original_text),
