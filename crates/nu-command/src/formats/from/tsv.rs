    ...
    fn examples(&self) -> Vec<Example<'_>> {
        vec![
            ...
            Example {
                ...
                example: "$'c1(char tab)c2(char tab)c3(char nl)1(char tab)2(char tab)3' | save tsv-data | open tsv-data | from tsv",
                result: None,
            },
            Example {
                description: "Create a tsv file without header columns and open it.",
                example: "$'a1(char tab)b1(char tab)c1(char nl)a2(char tab)b2(char tab)c2' | save tsv-data | open tsv-data | from tsv --noheaders",
                result: None,
            },
            Example {
                description: "Create a tsv file without header columns and open it, removing all unnecessary whitespaces.",
                example: "$'a1(char tab)b1(char tab)c1(char nl)a2(char tab)b2(char tab)c2' | save tsv-data | open tsv-data | from tsv --trim all",
                result: None,
            },
            Example {
                ...
                example: "$'a1(char tab)b1(char tab)c1(char nl)a2(char tab)b2(char tab)c2' | save tsv-data | open tsv-data | from tsv --trim headers",
                result: None,
            },
            Example {
                ...
                example: "$'a1(char tab)b1(char tab)c1(char nl)a2(char tab)b2(char tab)c2' | save tsv-data | open tsv-data | from tsv --trim fields",
                result: None,
            },
        ]
    }
...
mod test {
    ...
    fn test_examples() -> nu_test_support::Result {
        nu_test_support::test().examples(FromTsv)
    }
