    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            ...
            Example {
                ...
                example: "[[name type size]; [Cargo.toml toml 1kb] [Cargo.lock toml 2kb] \
                          [file.json json 3kb]] | reject 0 2",
                result: None,
            },
            Example {
            ...
            Example {
                ...
                example: "let cols = [type size]; [[name type size]; [Cargo.toml toml 1kb] \
