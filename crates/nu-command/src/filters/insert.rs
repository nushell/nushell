...
impl Command for Insert {
    ...
    fn extra_description(&self) -> &str {
        "When inserting a column, the closure will be run for each row, and the current row will \
         be passed as the first argument.
When inserting into a specific index, the closure will instead get the current value at the index \
         or null if inserting at the end of a list/table."
    }
