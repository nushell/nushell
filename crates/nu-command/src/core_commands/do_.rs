...
impl Command for Do {
    ...
    fn run(
        ...
        let ignore_shell_errors = call.has_flag("ignore-shell-errors");
        let ignore_program_errors = call.has_flag("ignore-program-errors");
        ...
        let result = eval_block(
            ...
            ignore_shell_errors || capture_errors,
        );
