...
fn generate_operator_info() -> Vec<OperatorInfo> {
    vec![
        ...
        OperatorInfo {
            ...
            operator: "in".into(),
            name: "In".into(),
            description: "Checks if a value is in a list.".into(),
            precedence: 80,
        },
        OperatorInfo {
            op_type: "Comparison".into(),
            ...
            name: "NotIn".into(),
            description: "Checks if a value is not in a list.".into(),
            precedence: 80,
        },
        OperatorInfo {
            op_type: "Comparison".into(),
            ...
            description: "Checks if a value starts with another.".into(),
            precedence: 80,
        },
        OperatorInfo {
            op_type: "Comparison".into(),
            ...
            name: "EndsWith".into(),
            description: "Checks if a value ends with another.".into(),
            precedence: 80,
        },
        OperatorInfo {
            op_type: "Comparison".into(),
            operator: "not".into(),
            name: "UnaryNot".into(),
            description: "Negates a value.".into(),
            precedence: 0,
        },
        OperatorInfo {
            op_type: "Math".into(),
