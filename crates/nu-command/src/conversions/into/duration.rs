...
fn convert_str_from_unit_to_unit(
    ...
    match (from_unit, to_unit) {
        ...
        ("sec", "µs") => Ok(val as f64 * 1000.0 * 1000.0),
        ...
        ("min", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0),
        ...
        ("hr", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0 * 60.0),
        ...
        ("day", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0 * 60.0 * 24.0),
        ...
        ("wk", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0 * 60.0 * 24.0 * 7.0),
        ...
        ("month", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0 * 60.0 * 24.0 * 30.0),
        ...
        ("yr", "µs") => Ok(val as f64 * 1000.0 * 1000.0 * 60.0 * 60.0 * 24.0 * 365.0),
