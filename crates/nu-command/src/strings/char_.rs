        ...
        if call.has_flag("list") {
            return Ok(CHAR_MAP
                ...
                .map(move |(name, s)| {
                    ...
                    Value::record(record! { name, character, unicode }, call_span)
                })
...
fn integer_to_unicode_char(value: i64, span: Span) -> Result<char, ShellError> {
...
fn string_to_unicode_char(s: &str, span: Span) -> Result<char, ShellError> {
