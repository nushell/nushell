    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            ...
            Example {
                ...
                result: Some(Value::test_binary([0x33, 0x44, 0x55, 0x10])),
            },
            Example {
                description:
                ...
                result: Some(Value::List {
                    vals: vec![Value::test_record(Record {
                        ...
                        vals: vec![
                            Value::test_binary([0x11, 0x12, 0x13]),
                            Value::test_binary([0x15, 0x16]),
                            Value::test_binary([0x18, 0x19]),
                        ],
                    })],
                    span: Span::test_data(),
                }),
