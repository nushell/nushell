...
pub fn rotate(
    ...
    if not_a_record {
        ...
        return Ok(
            Value::list(list![Value::record(record, call.head)], call.head)
                .into_pipeline_data()
