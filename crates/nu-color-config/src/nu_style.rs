...
impl IntoValue for NuStyle {
    fn into_value(self, span: Span) -> nu_protocol::Value {
        if self.bg.is_none() && self.attr.is_none() {
            // Simplify common case of foreground-only or default styles
            return self
                .fg
                .unwrap_or_else(|| color_to_string(Color::Default))
                .into_value(span);
        }
...
impl From<Style> for NuStyle {
    fn from(s: Style) -> Self {
        Self {
            bg: s.background.map(color_to_string),
            fg: s.foreground.map(color_to_string),
...
fn color_to_string(color: Color) -> String {
    match color {
        ...
        Color::LightPurple => String::from("light_purple"),
        ...
        Color::LightGray => String::from("light_gray"),
        ...
        Color::Fixed(0) => String::from("xterm_black"),
        Color::Fixed(1) => String::from("xterm_maroon"),
        Color::Fixed(2) => String::from("xterm_green"),
        Color::Fixed(3) => String::from("xterm_olive"),
        Color::Fixed(4) => String::from("xterm_navy"),
        Color::Fixed(5) => String::from("xterm_purplea"),
        Color::Fixed(6) => String::from("xterm_teal"),
        Color::Fixed(7) => String::from("xterm_silver"),
        Color::Fixed(8) => String::from("xterm_grey"),
        Color::Fixed(9) => String::from("xterm_red"),
        Color::Fixed(10) => String::from("xterm_lime"),
        Color::Fixed(11) => String::from("xterm_yellow"),
        Color::Fixed(12) => String::from("xterm_blue"),
        Color::Fixed(13) => String::from("xterm_fuchsia"),
        Color::Fixed(14) => String::from("xterm_aqua"),
        Color::Fixed(15) => String::from("xterm_white"),
        Color::Fixed(16) => String::from("xterm_grey0"),
        Color::Fixed(17) => String::from("xterm_navyblue"),
        Color::Fixed(18) => String::from("xterm_darkblue"),
        Color::Fixed(19) => String::from("xterm_blue3a"),
        Color::Fixed(20) => String::from("xterm_blue3b"),
        Color::Fixed(21) => String::from("xterm_blue1"),
        Color::Fixed(22) => String::from("xterm_darkgreen"),
        Color::Fixed(23) => String::from("xterm_deepskyblue4a"),
        Color::Fixed(24) => String::from("xterm_deepskyblue4b"),
        Color::Fixed(25) => String::from("xterm_deepskyblue4c"),
        Color::Fixed(26) => String::from("xterm_dodgerblue3"),
        Color::Fixed(27) => String::from("xterm_dodgerblue2"),
        Color::Fixed(28) => String::from("xterm_green4"),
        Color::Fixed(29) => String::from("xterm_springgreen4"),
        Color::Fixed(30) => String::from("xterm_turquoise4"),
        Color::Fixed(31) => String::from("xterm_deepskyblue3a"),
        Color::Fixed(32) => String::from("xterm_deepskyblue3b"),
        Color::Fixed(33) => String::from("xterm_dodgerblue1"),
        Color::Fixed(34) => String::from("xterm_green3a"),
        Color::Fixed(35) => String::from("xterm_springgreen3a"),
        Color::Fixed(36) => String::from("xterm_darkcyan"),
        Color::Fixed(37) => String::from("xterm_lightseagreen"),
        Color::Fixed(38) => String::from("xterm_deepskyblue2"),
        Color::Fixed(39) => String::from("xterm_deepskyblue1"),
        Color::Fixed(40) => String::from("xterm_green3b"),
        Color::Fixed(41) => String::from("xterm_springgreen3b"),
        Color::Fixed(42) => String::from("xterm_springgreen2a"),
        Color::Fixed(43) => String::from("xterm_cyan3"),
        Color::Fixed(44) => String::from("xterm_darkturquoise"),
        Color::Fixed(45) => String::from("xterm_turquoise2"),
        Color::Fixed(46) => String::from("xterm_green1"),
        Color::Fixed(47) => String::from("xterm_springgreen2b"),
        Color::Fixed(48) => String::from("xterm_springgreen1"),
        Color::Fixed(49) => String::from("xterm_mediumspringgreen"),
        Color::Fixed(50) => String::from("xterm_cyan2"),
        Color::Fixed(51) => String::from("xterm_cyan1"),
        Color::Fixed(52) => String::from("xterm_darkreda"),
        Color::Fixed(53) => String::from("xterm_deeppink4a"),
        Color::Fixed(54) => String::from("xterm_purple4a"),
        Color::Fixed(55) => String::from("xterm_purple4b"),
        Color::Fixed(56) => String::from("xterm_purple3"),
        Color::Fixed(57) => String::from("xterm_blueviolet"),
        Color::Fixed(58) => String::from("xterm_orange4a"),
        Color::Fixed(59) => String::from("xterm_grey37"),
        Color::Fixed(60) => String::from("xterm_mediumpurple4"),
        Color::Fixed(61) => String::from("xterm_slateblue3a"),
        Color::Fixed(62) => String::from("xterm_slateblue3b"),
        Color::Fixed(63) => String::from("xterm_royalblue1"),
        Color::Fixed(64) => String::from("xterm_chartreuse4"),
        Color::Fixed(65) => String::from("xterm_darkseagreen4a"),
        Color::Fixed(66) => String::from("xterm_paleturquoise4"),
        Color::Fixed(67) => String::from("xterm_steelblue"),
        Color::Fixed(68) => String::from("xterm_steelblue3"),
        Color::Fixed(69) => String::from("xterm_cornflowerblue"),
        Color::Fixed(70) => String::from("xterm_chartreuse3a"),
        Color::Fixed(71) => String::from("xterm_darkseagreen4b"),
        Color::Fixed(72) => String::from("xterm_cadetbluea"),
        Color::Fixed(73) => String::from("xterm_cadetblueb"),
        Color::Fixed(74) => String::from("xterm_skyblue3"),
        Color::Fixed(75) => String::from("xterm_steelblue1a"),
        Color::Fixed(76) => String::from("xterm_chartreuse3b"),
        Color::Fixed(77) => String::from("xterm_palegreen3a"),
        Color::Fixed(78) => String::from("xterm_seagreen3"),
        Color::Fixed(79) => String::from("xterm_aquamarine3"),
        Color::Fixed(80) => String::from("xterm_mediumturquoise"),
        Color::Fixed(81) => String::from("xterm_steelblue1b"),
        Color::Fixed(82) => String::from("xterm_chartreuse2a"),
        Color::Fixed(83) => String::from("xterm_seagreen2"),
        Color::Fixed(84) => String::from("xterm_seagreen1a"),
        Color::Fixed(85) => String::from("xterm_seagreen1b"),
        Color::Fixed(86) => String::from("xterm_aquamarine1a"),
        Color::Fixed(87) => String::from("xterm_darkslategray2"),
        Color::Fixed(88) => String::from("xterm_darkredb"),
        Color::Fixed(89) => String::from("xterm_deeppink4b"),
        Color::Fixed(90) => String::from("xterm_darkmagentaa"),
        Color::Fixed(91) => String::from("xterm_darkmagentab"),
        Color::Fixed(92) => String::from("xterm_darkvioleta"),
        Color::Fixed(93) => String::from("xterm_purpleb"),
        Color::Fixed(94) => String::from("xterm_orange4b"),
        Color::Fixed(95) => String::from("xterm_lightpink4"),
        Color::Fixed(96) => String::from("xterm_plum4"),
        Color::Fixed(97) => String::from("xterm_mediumpurple3a"),
        Color::Fixed(98) => String::from("xterm_mediumpurple3b"),
        Color::Fixed(99) => String::from("xterm_slateblue1"),
        Color::Fixed(100) => String::from("xterm_yellow4a"),
        Color::Fixed(101) => String::from("xterm_wheat4"),
        Color::Fixed(102) => String::from("xterm_grey53"),
        Color::Fixed(103) => String::from("xterm_lightslategrey"),
        Color::Fixed(104) => String::from("xterm_mediumpurple"),
        Color::Fixed(105) => String::from("xterm_lightslateblue"),
        Color::Fixed(106) => String::from("xterm_yellow4b"),
        Color::Fixed(107) => String::from("xterm_darkolivegreen3a"),
        Color::Fixed(108) => String::from("xterm_darkseagreen"),
        Color::Fixed(109) => String::from("xterm_lightskyblue3a"),
        Color::Fixed(110) => String::from("xterm_lightskyblue3b"),
        Color::Fixed(111) => String::from("xterm_skyblue2"),
        Color::Fixed(112) => String::from("xterm_chartreuse2b"),
        Color::Fixed(113) => String::from("xterm_darkolivegreen3b"),
        Color::Fixed(114) => String::from("xterm_palegreen3b"),
        Color::Fixed(115) => String::from("xterm_darkseagreen3a"),
        Color::Fixed(116) => String::from("xterm_darkslategray3"),
        Color::Fixed(117) => String::from("xterm_skyblue1"),
        Color::Fixed(118) => String::from("xterm_chartreuse1"),
        Color::Fixed(119) => String::from("xterm_lightgreena"),
        Color::Fixed(120) => String::from("xterm_lightgreenb"),
        Color::Fixed(121) => String::from("xterm_palegreen1a"),
        Color::Fixed(122) => String::from("xterm_aquamarine1b"),
        Color::Fixed(123) => String::from("xterm_darkslategray1"),
        Color::Fixed(124) => String::from("xterm_red3a"),
        Color::Fixed(125) => String::from("xterm_deeppink4c"),
        Color::Fixed(126) => String::from("xterm_mediumvioletred"),
        Color::Fixed(127) => String::from("xterm_magenta3"),
        Color::Fixed(128) => String::from("xterm_darkvioletb"),
        Color::Fixed(129) => String::from("xterm_purplec"),
        Color::Fixed(130) => String::from("xterm_darkorange3a"),
        Color::Fixed(131) => String::from("xterm_indianreda"),
        Color::Fixed(132) => String::from("xterm_hotpink3a"),
        Color::Fixed(133) => String::from("xterm_mediumorchid3"),
        Color::Fixed(134) => String::from("xterm_mediumorchid"),
        Color::Fixed(135) => String::from("xterm_mediumpurple2a"),
        Color::Fixed(136) => String::from("xterm_darkgoldenrod"),
        Color::Fixed(137) => String::from("xterm_lightsalmon3a"),
        Color::Fixed(138) => String::from("xterm_rosybrown"),
        Color::Fixed(139) => String::from("xterm_grey63"),
        Color::Fixed(140) => String::from("xterm_mediumpurple2b"),
        Color::Fixed(141) => String::from("xterm_mediumpurple1"),
        Color::Fixed(142) => String::from("xterm_gold3a"),
        Color::Fixed(143) => String::from("xterm_darkkhaki"),
        Color::Fixed(144) => String::from("xterm_navajowhite3"),
        Color::Fixed(145) => String::from("xterm_grey69"),
        Color::Fixed(146) => String::from("xterm_lightsteelblue3"),
        Color::Fixed(147) => String::from("xterm_lightsteelblue"),
        Color::Fixed(148) => String::from("xterm_yellow3a"),
        Color::Fixed(149) => String::from("xterm_darkolivegreen3c"),
        Color::Fixed(150) => String::from("xterm_darkseagreen3b"),
        Color::Fixed(151) => String::from("xterm_darkseagreen2a"),
        Color::Fixed(152) => String::from("xterm_lightcyan3"),
        Color::Fixed(153) => String::from("xterm_lightskyblue1"),
        Color::Fixed(154) => String::from("xterm_greenyellow"),
        Color::Fixed(155) => String::from("xterm_darkolivegreen2"),
        Color::Fixed(156) => String::from("xterm_palegreen1b"),
        Color::Fixed(157) => String::from("xterm_darkseagreen2b"),
        Color::Fixed(158) => String::from("xterm_darkseagreen1a"),
        Color::Fixed(159) => String::from("xterm_paleturquoise1"),
        Color::Fixed(160) => String::from("xterm_red3b"),
        Color::Fixed(161) => String::from("xterm_deeppink3a"),
        Color::Fixed(162) => String::from("xterm_deeppink3b"),
        Color::Fixed(163) => String::from("xterm_magenta3a"),
        Color::Fixed(164) => String::from("xterm_magenta3b"),
        Color::Fixed(165) => String::from("xterm_magenta2a"),
        Color::Fixed(166) => String::from("xterm_darkorange3b"),
        Color::Fixed(167) => String::from("xterm_indianredb"),
        Color::Fixed(168) => String::from("xterm_hotpink3b"),
        Color::Fixed(169) => String::from("xterm_hotpink2"),
        Color::Fixed(170) => String::from("xterm_orchid"),
        Color::Fixed(171) => String::from("xterm_mediumorchid1a"),
        Color::Fixed(172) => String::from("xterm_orange3"),
        Color::Fixed(173) => String::from("xterm_lightsalmon3b"),
        Color::Fixed(174) => String::from("xterm_lightpink3"),
        Color::Fixed(175) => String::from("xterm_pink3"),
        Color::Fixed(176) => String::from("xterm_plum3"),
        Color::Fixed(177) => String::from("xterm_violet"),
        Color::Fixed(178) => String::from("xterm_gold3b"),
        Color::Fixed(179) => String::from("xterm_lightgoldenrod3"),
        Color::Fixed(180) => String::from("xterm_tan"),
        Color::Fixed(181) => String::from("xterm_mistyrose3"),
        Color::Fixed(182) => String::from("xterm_thistle3"),
        Color::Fixed(183) => String::from("xterm_plum2"),
        Color::Fixed(184) => String::from("xterm_yellow3b"),
        Color::Fixed(185) => String::from("xterm_khaki3"),
        Color::Fixed(186) => String::from("xterm_lightgoldenrod2"),
        Color::Fixed(187) => String::from("xterm_lightyellow3"),
        Color::Fixed(188) => String::from("xterm_grey84"),
        Color::Fixed(189) => String::from("xterm_lightsteelblue1"),
        Color::Fixed(190) => String::from("xterm_yellow2"),
        Color::Fixed(191) => String::from("xterm_darkolivegreen1a"),
        Color::Fixed(192) => String::from("xterm_darkolivegreen1b"),
        Color::Fixed(193) => String::from("xterm_darkseagreen1b"),
        Color::Fixed(194) => String::from("xterm_honeydew2"),
        Color::Fixed(195) => String::from("xterm_lightcyan1"),
        Color::Fixed(196) => String::from("xterm_red1"),
        Color::Fixed(197) => String::from("xterm_deeppink2"),
        Color::Fixed(198) => String::from("xterm_deeppink1a"),
        Color::Fixed(199) => String::from("xterm_deeppink1b"),
        Color::Fixed(200) => String::from("xterm_magenta2b"),
        Color::Fixed(201) => String::from("xterm_magenta1"),
        Color::Fixed(202) => String::from("xterm_orangered1"),
        Color::Fixed(203) => String::from("xterm_indianred1a"),
        Color::Fixed(204) => String::from("xterm_indianred1b"),
        Color::Fixed(205) => String::from("xterm_hotpinka"),
        Color::Fixed(206) => String::from("xterm_hotpinkb"),
        Color::Fixed(207) => String::from("xterm_mediumorchid1b"),
        Color::Fixed(208) => String::from("xterm_darkorange"),
        Color::Fixed(209) => String::from("xterm_salmon1"),
        Color::Fixed(210) => String::from("xterm_lightcoral"),
        Color::Fixed(211) => String::from("xterm_palevioletred1"),
        Color::Fixed(212) => String::from("xterm_orchid2"),
        Color::Fixed(213) => String::from("xterm_orchid1"),
        Color::Fixed(214) => String::from("xterm_orange1"),
        Color::Fixed(215) => String::from("xterm_sandybrown"),
        Color::Fixed(216) => String::from("xterm_lightsalmon1"),
        Color::Fixed(217) => String::from("xterm_lightpink1"),
        Color::Fixed(218) => String::from("xterm_pink1"),
        Color::Fixed(219) => String::from("xterm_plum1"),
        Color::Fixed(220) => String::from("xterm_gold1"),
        Color::Fixed(221) => String::from("xterm_lightgoldenrod2a"),
        Color::Fixed(222) => String::from("xterm_lightgoldenrod2b"),
        Color::Fixed(223) => String::from("xterm_navajowhite1"),
        Color::Fixed(224) => String::from("xterm_mistyrose1"),
        Color::Fixed(225) => String::from("xterm_thistle1"),
        Color::Fixed(226) => String::from("xterm_yellow1"),
        Color::Fixed(227) => String::from("xterm_lightgoldenrod1"),
        Color::Fixed(228) => String::from("xterm_khaki1"),
        Color::Fixed(229) => String::from("xterm_wheat1"),
        Color::Fixed(230) => String::from("xterm_cornsilk1"),
        Color::Fixed(231) => String::from("xterm_grey100"),
        Color::Fixed(232) => String::from("xterm_grey3"),
        Color::Fixed(233) => String::from("xterm_grey7"),
        Color::Fixed(234) => String::from("xterm_grey11"),
        Color::Fixed(235) => String::from("xterm_grey15"),
        Color::Fixed(236) => String::from("xterm_grey19"),
        Color::Fixed(237) => String::from("xterm_grey23"),
        Color::Fixed(238) => String::from("xterm_grey27"),
        Color::Fixed(239) => String::from("xterm_grey30"),
        Color::Fixed(240) => String::from("xterm_grey35"),
        Color::Fixed(241) => String::from("xterm_grey39"),
        Color::Fixed(242) => String::from("xterm_grey42"),
        Color::Fixed(243) => String::from("xterm_grey46"),
        Color::Fixed(244) => String::from("xterm_grey50"),
        Color::Fixed(245) => String::from("xterm_grey54"),
        Color::Fixed(246) => String::from("xterm_grey58"),
        Color::Fixed(247) => String::from("xterm_grey62"),
        Color::Fixed(248) => String::from("xterm_grey66"),
        Color::Fixed(249) => String::from("xterm_grey70"),
        Color::Fixed(250) => String::from("xterm_grey74"),
        Color::Fixed(251) => String::from("xterm_grey78"),
        Color::Fixed(252) => String::from("xterm_grey82"),
        Color::Fixed(253) => String::from("xterm_grey85"),
        Color::Fixed(254) => String::from("xterm_grey89"),
        Color::Fixed(255) => String::from("xterm_grey93"),
    }
}
...
mod tests {
    ...
    fn style_to_value() {
        ...
        assert_eq!(
            NuStyle::from(Style::default()).into_value(span),
            json!("default").into_value(span),
        );

        assert_eq!(
            NuStyle::from(Style::default().fg(Color::Red)).into_value(span),
            json!("red").into_value(span),
        );

        assert_eq!(
            NuStyle::from(Style::default().fg(Color::Red).bold()).into_value(span),
            json!({
                "fg": "red",
                "attr": "b",
            })
        ...
        assert_eq!(
            NuStyle::from(Style::default().fg(Color::Rgb(0x11, 0x22, 0x33))).into_value(span),
            json!("#112233").into_value(span)
        );

        assert_eq!(
            NuStyle::from(Style::default().fg(Color::Fixed(123))).into_value(span),
            json!("xterm_darkslategray1").into_value(span)
        );
    }
}
