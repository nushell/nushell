...
fn color_to_string(color: Color) -> Option<String> {
    match color {
        ...
        // Fixed colors generated via `ansi --list`. Might be nice to somehow
        // define a single source of truth to share with `lookup_color` and
        // `ansi --list`, maybe with a macro?
        Color::Fixed(0) => Some(String::from("xterm_black")),
        Color::Fixed(1) => Some(String::from("xterm_maroon")),
        Color::Fixed(2) => Some(String::from("xterm_green")),
        Color::Fixed(3) => Some(String::from("xterm_olive")),
        Color::Fixed(4) => Some(String::from("xterm_navy")),
        Color::Fixed(5) => Some(String::from("xterm_purplea")),
        Color::Fixed(6) => Some(String::from("xterm_teal")),
        Color::Fixed(7) => Some(String::from("xterm_silver")),
        Color::Fixed(8) => Some(String::from("xterm_grey")),
        Color::Fixed(9) => Some(String::from("xterm_red")),
        Color::Fixed(10) => Some(String::from("xterm_lime")),
        Color::Fixed(11) => Some(String::from("xterm_yellow")),
        Color::Fixed(12) => Some(String::from("xterm_blue")),
        Color::Fixed(13) => Some(String::from("xterm_fuchsia")),
        Color::Fixed(14) => Some(String::from("xterm_aqua")),
        Color::Fixed(15) => Some(String::from("xterm_white")),
        Color::Fixed(16) => Some(String::from("xterm_grey0")),
        Color::Fixed(17) => Some(String::from("xterm_navyblue")),
        Color::Fixed(18) => Some(String::from("xterm_darkblue")),
        Color::Fixed(19) => Some(String::from("xterm_blue3a")),
        Color::Fixed(20) => Some(String::from("xterm_blue3b")),
        Color::Fixed(21) => Some(String::from("xterm_blue1")),
        Color::Fixed(22) => Some(String::from("xterm_darkgreen")),
        Color::Fixed(23) => Some(String::from("xterm_deepskyblue4a")),
        Color::Fixed(24) => Some(String::from("xterm_deepskyblue4b")),
        Color::Fixed(25) => Some(String::from("xterm_deepskyblue4c")),
        Color::Fixed(26) => Some(String::from("xterm_dodgerblue3")),
        Color::Fixed(27) => Some(String::from("xterm_dodgerblue2")),
        Color::Fixed(28) => Some(String::from("xterm_green4")),
        Color::Fixed(29) => Some(String::from("xterm_springgreen4")),
        Color::Fixed(30) => Some(String::from("xterm_turquoise4")),
        Color::Fixed(31) => Some(String::from("xterm_deepskyblue3a")),
        Color::Fixed(32) => Some(String::from("xterm_deepskyblue3b")),
        Color::Fixed(33) => Some(String::from("xterm_dodgerblue1")),
        Color::Fixed(34) => Some(String::from("xterm_green3a")),
        Color::Fixed(35) => Some(String::from("xterm_springgreen3a")),
        Color::Fixed(36) => Some(String::from("xterm_darkcyan")),
        Color::Fixed(37) => Some(String::from("xterm_lightseagreen")),
        Color::Fixed(38) => Some(String::from("xterm_deepskyblue2")),
        Color::Fixed(39) => Some(String::from("xterm_deepskyblue1")),
        Color::Fixed(40) => Some(String::from("xterm_green3b")),
        Color::Fixed(41) => Some(String::from("xterm_springgreen3b")),
        Color::Fixed(42) => Some(String::from("xterm_springgreen2a")),
        Color::Fixed(43) => Some(String::from("xterm_cyan3")),
        Color::Fixed(44) => Some(String::from("xterm_darkturquoise")),
        Color::Fixed(45) => Some(String::from("xterm_turquoise2")),
        Color::Fixed(46) => Some(String::from("xterm_green1")),
        Color::Fixed(47) => Some(String::from("xterm_springgreen2b")),
        Color::Fixed(48) => Some(String::from("xterm_springgreen1")),
        Color::Fixed(49) => Some(String::from("xterm_mediumspringgreen")),
        Color::Fixed(50) => Some(String::from("xterm_cyan2")),
        Color::Fixed(51) => Some(String::from("xterm_cyan1")),
        Color::Fixed(52) => Some(String::from("xterm_darkreda")),
        Color::Fixed(53) => Some(String::from("xterm_deeppink4a")),
        Color::Fixed(54) => Some(String::from("xterm_purple4a")),
        Color::Fixed(55) => Some(String::from("xterm_purple4b")),
        Color::Fixed(56) => Some(String::from("xterm_purple3")),
        Color::Fixed(57) => Some(String::from("xterm_blueviolet")),
        Color::Fixed(58) => Some(String::from("xterm_orange4a")),
        Color::Fixed(59) => Some(String::from("xterm_grey37")),
        Color::Fixed(60) => Some(String::from("xterm_mediumpurple4")),
        Color::Fixed(61) => Some(String::from("xterm_slateblue3a")),
        Color::Fixed(62) => Some(String::from("xterm_slateblue3b")),
        Color::Fixed(63) => Some(String::from("xterm_royalblue1")),
        Color::Fixed(64) => Some(String::from("xterm_chartreuse4")),
        Color::Fixed(65) => Some(String::from("xterm_darkseagreen4a")),
        Color::Fixed(66) => Some(String::from("xterm_paleturquoise4")),
        Color::Fixed(67) => Some(String::from("xterm_steelblue")),
        Color::Fixed(68) => Some(String::from("xterm_steelblue3")),
        Color::Fixed(69) => Some(String::from("xterm_cornflowerblue")),
        Color::Fixed(70) => Some(String::from("xterm_chartreuse3a")),
        Color::Fixed(71) => Some(String::from("xterm_darkseagreen4b")),
        Color::Fixed(72) => Some(String::from("xterm_cadetbluea")),
        Color::Fixed(73) => Some(String::from("xterm_cadetblueb")),
        Color::Fixed(74) => Some(String::from("xterm_skyblue3")),
        Color::Fixed(75) => Some(String::from("xterm_steelblue1a")),
        Color::Fixed(76) => Some(String::from("xterm_chartreuse3b")),
        Color::Fixed(77) => Some(String::from("xterm_palegreen3a")),
        Color::Fixed(78) => Some(String::from("xterm_seagreen3")),
        Color::Fixed(79) => Some(String::from("xterm_aquamarine3")),
        Color::Fixed(80) => Some(String::from("xterm_mediumturquoise")),
        Color::Fixed(81) => Some(String::from("xterm_steelblue1b")),
        Color::Fixed(82) => Some(String::from("xterm_chartreuse2a")),
        Color::Fixed(83) => Some(String::from("xterm_seagreen2")),
        Color::Fixed(84) => Some(String::from("xterm_seagreen1a")),
        Color::Fixed(85) => Some(String::from("xterm_seagreen1b")),
        Color::Fixed(86) => Some(String::from("xterm_aquamarine1a")),
        Color::Fixed(87) => Some(String::from("xterm_darkslategray2")),
        Color::Fixed(88) => Some(String::from("xterm_darkredb")),
        Color::Fixed(89) => Some(String::from("xterm_deeppink4b")),
        Color::Fixed(90) => Some(String::from("xterm_darkmagentaa")),
        Color::Fixed(91) => Some(String::from("xterm_darkmagentab")),
        Color::Fixed(92) => Some(String::from("xterm_darkvioleta")),
        Color::Fixed(93) => Some(String::from("xterm_purpleb")),
        Color::Fixed(94) => Some(String::from("xterm_orange4b")),
        Color::Fixed(95) => Some(String::from("xterm_lightpink4")),
        Color::Fixed(96) => Some(String::from("xterm_plum4")),
        Color::Fixed(97) => Some(String::from("xterm_mediumpurple3a")),
        Color::Fixed(98) => Some(String::from("xterm_mediumpurple3b")),
        Color::Fixed(99) => Some(String::from("xterm_slateblue1")),
        Color::Fixed(100) => Some(String::from("xterm_yellow4a")),
        Color::Fixed(101) => Some(String::from("xterm_wheat4")),
        Color::Fixed(102) => Some(String::from("xterm_grey53")),
        Color::Fixed(103) => Some(String::from("xterm_lightslategrey")),
        Color::Fixed(104) => Some(String::from("xterm_mediumpurple")),
        Color::Fixed(105) => Some(String::from("xterm_lightslateblue")),
        Color::Fixed(106) => Some(String::from("xterm_yellow4b")),
        Color::Fixed(107) => Some(String::from("xterm_darkolivegreen3a")),
        Color::Fixed(108) => Some(String::from("xterm_darkseagreen")),
        Color::Fixed(109) => Some(String::from("xterm_lightskyblue3a")),
        Color::Fixed(110) => Some(String::from("xterm_lightskyblue3b")),
        Color::Fixed(111) => Some(String::from("xterm_skyblue2")),
        Color::Fixed(112) => Some(String::from("xterm_chartreuse2b")),
        Color::Fixed(113) => Some(String::from("xterm_darkolivegreen3b")),
        Color::Fixed(114) => Some(String::from("xterm_palegreen3b")),
        Color::Fixed(115) => Some(String::from("xterm_darkseagreen3a")),
        Color::Fixed(116) => Some(String::from("xterm_darkslategray3")),
        Color::Fixed(117) => Some(String::from("xterm_skyblue1")),
        Color::Fixed(118) => Some(String::from("xterm_chartreuse1")),
        Color::Fixed(119) => Some(String::from("xterm_lightgreena")),
        Color::Fixed(120) => Some(String::from("xterm_lightgreenb")),
        Color::Fixed(121) => Some(String::from("xterm_palegreen1a")),
        Color::Fixed(122) => Some(String::from("xterm_aquamarine1b")),
        Color::Fixed(123) => Some(String::from("xterm_darkslategray1")),
        Color::Fixed(124) => Some(String::from("xterm_red3a")),
        Color::Fixed(125) => Some(String::from("xterm_deeppink4c")),
        Color::Fixed(126) => Some(String::from("xterm_mediumvioletred")),
        Color::Fixed(127) => Some(String::from("xterm_magenta3")),
        Color::Fixed(128) => Some(String::from("xterm_darkvioletb")),
        Color::Fixed(129) => Some(String::from("xterm_purplec")),
        Color::Fixed(130) => Some(String::from("xterm_darkorange3a")),
        Color::Fixed(131) => Some(String::from("xterm_indianreda")),
        Color::Fixed(132) => Some(String::from("xterm_hotpink3a")),
        Color::Fixed(133) => Some(String::from("xterm_mediumorchid3")),
        Color::Fixed(134) => Some(String::from("xterm_mediumorchid")),
        Color::Fixed(135) => Some(String::from("xterm_mediumpurple2a")),
        Color::Fixed(136) => Some(String::from("xterm_darkgoldenrod")),
        Color::Fixed(137) => Some(String::from("xterm_lightsalmon3a")),
        Color::Fixed(138) => Some(String::from("xterm_rosybrown")),
        Color::Fixed(139) => Some(String::from("xterm_grey63")),
        Color::Fixed(140) => Some(String::from("xterm_mediumpurple2b")),
        Color::Fixed(141) => Some(String::from("xterm_mediumpurple1")),
        Color::Fixed(142) => Some(String::from("xterm_gold3a")),
        Color::Fixed(143) => Some(String::from("xterm_darkkhaki")),
        Color::Fixed(144) => Some(String::from("xterm_navajowhite3")),
        Color::Fixed(145) => Some(String::from("xterm_grey69")),
        Color::Fixed(146) => Some(String::from("xterm_lightsteelblue3")),
        Color::Fixed(147) => Some(String::from("xterm_lightsteelblue")),
        Color::Fixed(148) => Some(String::from("xterm_yellow3a")),
        Color::Fixed(149) => Some(String::from("xterm_darkolivegreen3c")),
        Color::Fixed(150) => Some(String::from("xterm_darkseagreen3b")),
        Color::Fixed(151) => Some(String::from("xterm_darkseagreen2a")),
        Color::Fixed(152) => Some(String::from("xterm_lightcyan3")),
        Color::Fixed(153) => Some(String::from("xterm_lightskyblue1")),
        Color::Fixed(154) => Some(String::from("xterm_greenyellow")),
        Color::Fixed(155) => Some(String::from("xterm_darkolivegreen2")),
        Color::Fixed(156) => Some(String::from("xterm_palegreen1b")),
        Color::Fixed(157) => Some(String::from("xterm_darkseagreen2b")),
        Color::Fixed(158) => Some(String::from("xterm_darkseagreen1a")),
        Color::Fixed(159) => Some(String::from("xterm_paleturquoise1")),
        Color::Fixed(160) => Some(String::from("xterm_red3b")),
        Color::Fixed(161) => Some(String::from("xterm_deeppink3a")),
        Color::Fixed(162) => Some(String::from("xterm_deeppink3b")),
        Color::Fixed(163) => Some(String::from("xterm_magenta3a")),
        Color::Fixed(164) => Some(String::from("xterm_magenta3b")),
        Color::Fixed(165) => Some(String::from("xterm_magenta2a")),
        Color::Fixed(166) => Some(String::from("xterm_darkorange3b")),
        Color::Fixed(167) => Some(String::from("xterm_indianredb")),
        Color::Fixed(168) => Some(String::from("xterm_hotpink3b")),
        Color::Fixed(169) => Some(String::from("xterm_hotpink2")),
        Color::Fixed(170) => Some(String::from("xterm_orchid")),
        Color::Fixed(171) => Some(String::from("xterm_mediumorchid1a")),
        Color::Fixed(172) => Some(String::from("xterm_orange3")),
        Color::Fixed(173) => Some(String::from("xterm_lightsalmon3b")),
        Color::Fixed(174) => Some(String::from("xterm_lightpink3")),
        Color::Fixed(175) => Some(String::from("xterm_pink3")),
        Color::Fixed(176) => Some(String::from("xterm_plum3")),
        Color::Fixed(177) => Some(String::from("xterm_violet")),
        Color::Fixed(178) => Some(String::from("xterm_gold3b")),
        Color::Fixed(179) => Some(String::from("xterm_lightgoldenrod3")),
        Color::Fixed(180) => Some(String::from("xterm_tan")),
        Color::Fixed(181) => Some(String::from("xterm_mistyrose3")),
        Color::Fixed(182) => Some(String::from("xterm_thistle3")),
        Color::Fixed(183) => Some(String::from("xterm_plum2")),
        Color::Fixed(184) => Some(String::from("xterm_yellow3b")),
        Color::Fixed(185) => Some(String::from("xterm_khaki3")),
        Color::Fixed(186) => Some(String::from("xterm_lightgoldenrod2")),
        Color::Fixed(187) => Some(String::from("xterm_lightyellow3")),
        Color::Fixed(188) => Some(String::from("xterm_grey84")),
        Color::Fixed(189) => Some(String::from("xterm_lightsteelblue1")),
        Color::Fixed(190) => Some(String::from("xterm_yellow2")),
        Color::Fixed(191) => Some(String::from("xterm_darkolivegreen1a")),
        Color::Fixed(192) => Some(String::from("xterm_darkolivegreen1b")),
        Color::Fixed(193) => Some(String::from("xterm_darkseagreen1b")),
        Color::Fixed(194) => Some(String::from("xterm_honeydew2")),
        Color::Fixed(195) => Some(String::from("xterm_lightcyan1")),
        Color::Fixed(196) => Some(String::from("xterm_red1")),
        Color::Fixed(197) => Some(String::from("xterm_deeppink2")),
        Color::Fixed(198) => Some(String::from("xterm_deeppink1a")),
        Color::Fixed(199) => Some(String::from("xterm_deeppink1b")),
        Color::Fixed(200) => Some(String::from("xterm_magenta2b")),
        Color::Fixed(201) => Some(String::from("xterm_magenta1")),
        Color::Fixed(202) => Some(String::from("xterm_orangered1")),
        Color::Fixed(203) => Some(String::from("xterm_indianred1a")),
        Color::Fixed(204) => Some(String::from("xterm_indianred1b")),
        Color::Fixed(205) => Some(String::from("xterm_hotpinka")),
        Color::Fixed(206) => Some(String::from("xterm_hotpinkb")),
        Color::Fixed(207) => Some(String::from("xterm_mediumorchid1b")),
        Color::Fixed(208) => Some(String::from("xterm_darkorange")),
        Color::Fixed(209) => Some(String::from("xterm_salmon1")),
        Color::Fixed(210) => Some(String::from("xterm_lightcoral")),
        Color::Fixed(211) => Some(String::from("xterm_palevioletred1")),
        Color::Fixed(212) => Some(String::from("xterm_orchid2")),
        Color::Fixed(213) => Some(String::from("xterm_orchid1")),
        Color::Fixed(214) => Some(String::from("xterm_orange1")),
        Color::Fixed(215) => Some(String::from("xterm_sandybrown")),
        Color::Fixed(216) => Some(String::from("xterm_lightsalmon1")),
        Color::Fixed(217) => Some(String::from("xterm_lightpink1")),
        Color::Fixed(218) => Some(String::from("xterm_pink1")),
        Color::Fixed(219) => Some(String::from("xterm_plum1")),
        Color::Fixed(220) => Some(String::from("xterm_gold1")),
        Color::Fixed(221) => Some(String::from("xterm_lightgoldenrod2a")),
        Color::Fixed(222) => Some(String::from("xterm_lightgoldenrod2b")),
        Color::Fixed(223) => Some(String::from("xterm_navajowhite1")),
        Color::Fixed(224) => Some(String::from("xterm_mistyrose1")),
        Color::Fixed(225) => Some(String::from("xterm_thistle1")),
        Color::Fixed(226) => Some(String::from("xterm_yellow1")),
        Color::Fixed(227) => Some(String::from("xterm_lightgoldenrod1")),
        Color::Fixed(228) => Some(String::from("xterm_khaki1")),
        Color::Fixed(229) => Some(String::from("xterm_wheat1")),
        Color::Fixed(230) => Some(String::from("xterm_cornsilk1")),
        Color::Fixed(231) => Some(String::from("xterm_grey100")),
        Color::Fixed(232) => Some(String::from("xterm_grey3")),
        Color::Fixed(233) => Some(String::from("xterm_grey7")),
        Color::Fixed(234) => Some(String::from("xterm_grey11")),
        Color::Fixed(235) => Some(String::from("xterm_grey15")),
        Color::Fixed(236) => Some(String::from("xterm_grey19")),
        Color::Fixed(237) => Some(String::from("xterm_grey23")),
        Color::Fixed(238) => Some(String::from("xterm_grey27")),
        Color::Fixed(239) => Some(String::from("xterm_grey30")),
        Color::Fixed(240) => Some(String::from("xterm_grey35")),
        Color::Fixed(241) => Some(String::from("xterm_grey39")),
        Color::Fixed(242) => Some(String::from("xterm_grey42")),
        Color::Fixed(243) => Some(String::from("xterm_grey46")),
        Color::Fixed(244) => Some(String::from("xterm_grey50")),
        Color::Fixed(245) => Some(String::from("xterm_grey54")),
        Color::Fixed(246) => Some(String::from("xterm_grey58")),
        Color::Fixed(247) => Some(String::from("xterm_grey62")),
        Color::Fixed(248) => Some(String::from("xterm_grey66")),
        Color::Fixed(249) => Some(String::from("xterm_grey70")),
        Color::Fixed(250) => Some(String::from("xterm_grey74")),
        Color::Fixed(251) => Some(String::from("xterm_grey78")),
        Color::Fixed(252) => Some(String::from("xterm_grey82")),
        Color::Fixed(253) => Some(String::from("xterm_grey85")),
        Color::Fixed(254) => Some(String::from("xterm_grey89")),
        Color::Fixed(255) => Some(String::from("xterm_grey93")),
    }
}
