...
def get-all-operators [] { return [
    ...
    [Comparison, like, RegexMatch, "Checks if a value matches a regular expression.", 80]
    [Comparison, !~, NotRegexMatch, "Checks if a value does not match a regular expression.", 80]
    [Comparison, not-like, NotRegexMatch, "Checks if a value does not match a regular expression.", 80]
