...
impl Display for FlatShape {
    fn fmt(&self, f: &mut Formatter) -> Result {
        match self {
            FlatShape::Garbage => write!(f, "flatshape-garbage"),
            FlatShape::Nothing => write!(f, "flatshape-nothing"),
            FlatShape::Bool => write!(f, "flatshape-bool"),
            FlatShape::Int => write!(f, "flatshape-int"),
            FlatShape::Float => write!(f, "flatshape-float"),
            FlatShape::Range => write!(f, "flatshape-range"),
            FlatShape::InternalCall => write!(f, "flatshape-internalcall"),
            FlatShape::External => write!(f, "flatshape-external"),
            FlatShape::ExternalArg => write!(f, "flatshape-externalarg"),
            FlatShape::Literal => write!(f, "flatshape-literal"),
            FlatShape::Operator => write!(f, "flatshape-operator"),
            FlatShape::Signature => write!(f, "flatshape-signature"),
            FlatShape::String => write!(f, "flatshape-string"),
            FlatShape::StringInterpolation => write!(f, "flatshape-string-interpolation"),
            FlatShape::List => write!(f, "flatshape-string-interpolation"),
            FlatShape::Table => write!(f, "flatshape-table"),
            FlatShape::Record => write!(f, "flatshape-record"),
            FlatShape::Block => write!(f, "flatshape-block"),
            FlatShape::Filepath => write!(f, "flatshape-filepath"),
            FlatShape::GlobPattern => write!(f, "flatshape-globpattern"),
            FlatShape::Variable => write!(f, "flatshape-variable"),
            FlatShape::Flag => write!(f, "flatshape-flag"),
            FlatShape::Custom(_) => write!(f, "flatshape-custom"),
        }
    }
}
